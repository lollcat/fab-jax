...
Indices = chex.Array  # Indices of samples in buffer.
BatchSize = int
...
class PrioritisedBuffer(NamedTuple):
    init: Callable[[Sample, LogWeight, LogProbQ], PrioritisedBufferState]
    add: Callable[[Sample, LogWeight, LogProbQ, PrioritisedBufferState], PrioritisedBufferState]
    sample: Callable[[chex.PRNGKey, PrioritisedBufferState, BatchSize], Tuple[Sample, LogProbQ, Indices]]
    sample_n_batches: Callable[[chex.PRNGKey, PrioritisedBufferState, BatchSize, int],
                                Tuple[Sample, LogProbQ, Indices]]
    adjust: Callable[[Sample, LogProbQ, Indices, PrioritisedBufferState], PrioritisedBufferState]
...
def build_prioritised_buffer(
    ...
    def init(x: Sample, log_w: LogWeight, log_q_old: LogProbQ) -> PrioritisedBufferState:
        """
